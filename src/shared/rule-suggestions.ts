...
// available, or the exact description otherwise. New suggestions light the
// Activity dot and live in the Settings rules card and Activity page until
// accepted or dismissed. Neither is forever:
