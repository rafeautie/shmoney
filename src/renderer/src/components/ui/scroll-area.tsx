...
function ScrollBar({
  ...
  return (
    <ScrollAreaPrimitive.Scrollbar
      ...
      className={cn(
        'flex touch-none p-px transition-[color,opacity] select-none opacity-0 data-hovering:opacity-100 data-scrolling:opacity-100 data-horizontal:h-2.5 data-horizontal:flex-col data-horizontal:border-t data-horizontal:border-t-transparent data-vertical:h-full data-vertical:w-2.5 data-vertical:border-l data-vertical:border-l-transparent',
        className
      )}
      {...props}
    >
