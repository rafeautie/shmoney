...
const inputGroupButtonVariants = cva(
  ...
  'flex cursor-default items-center gap-1 rounded-md text-xs/relaxed shadow-none',
  {
    variants: {
      size: {
        sm: '',
