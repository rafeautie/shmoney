  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        // An open Radix Select (or other popper) blanks pointer-events on the sheet
        // while open, so dismissing its popup with a click inside the sheet is
        // reported as an outside pointer-down that would close the sheet. Keep it
        // open when the click physically landed within the sheet's bounds; genuine
