...
const STACK = [
  ...
  { name: 'TanStack Table', description: 'Headless table used on the Notes page' },
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          This is an Electron + React + TypeScript starter wired up with the stack below. See the
          Notes page for a working example.
        </p>
      </div>
